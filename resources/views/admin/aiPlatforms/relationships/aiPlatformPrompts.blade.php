...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-aiPlatformPrompts">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($prompts as $key => $prompt)
                        <tr data-entry-id="{{ $prompt->id }}">
                            ...
                            <td>
                                @foreach($prompt->ai_platforms as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-aiPlatformPrompts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
